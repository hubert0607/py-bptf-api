...
from .models.v2 import UpdateListingV2, ListingV2, ScrollableListing
...
class BatchRequest():
    ...
    def __init__(self, token):
        self.token = token
        self.batch_listings: list[ListingV1] = []
...
class Classifieds:
    ...
    def update_listing(self, listing_id: str, update_model: UpdateListingV2) -> ListingV2:
...
if __name__ == "__main__":
    ...
    snapshot = c.get_snapshot("Strange Rocket Launcher")
    print(snapshot)
